...
const T = {
  en: {
    ...
    "lp.feat.f1d":  "Claude Sonnet reads every submission document the moment it arrives — PDF, Word, or email body, extracting 30+ risk fields automatically. Accuracy figures will be published once we complete testing with design partners.",
    ...
    "lp.feat.f3d":  "We're building automatic Core Data Record generation on every bind, aligned with ACORD 28 — designed so the CDR mandate doesn't mean extra engineering work for your team.",
    ...
    // Landing page — roadmap ("coming soon" — honest about what's planned vs. live)
    "lp.road.tag":  "Roadmap",
    "lp.road.h2":   "Where we're headed next",
    "lp.road.sub":  "Velox is being built in the open with our design partners. Here's what's already shipping, and what's coming next.",
    "lp.road.badge.now":  "In product today",
    "lp.road.badge.soon": "Coming soon",
    "lp.road.r1t":  "Two-tier approval workflows",
    "lp.road.r1d":  "Senior sign-off on high-risk referrals, with a full record of who approved what and why — built for regulatory defensibility.",
    "lp.road.r2t":  "Policy admin integrations",
    "lp.road.r2d":  "Push bound risks straight into systems like Sequel or EZLynx — no more re-keying the same submission twice.",
    "lp.road.r3t":  "Reinsurance & treaty placement helper",
    "lp.road.r3d":  "Auto-generate exposure sheets by peril and limit, and get suggested treaty matches based on class and territory.",
    "lp.road.r4t":  "SLA tracking & alerts",
    "lp.road.r4d":  "Configurable time-to-decision targets per broker, class, and underwriter — with proactive alerts before you breach them.",
    "lp.road.r5t":  "Rules library & version control",
    "lp.road.r5d":  "Pre-built appetite rule sets by class, with rollback and A/B testing — so new underwriters ramp up in days, not months.",
    "lp.road.r6t":  "Native mobile app",
    "lp.road.r6d":  "Review and decide on referred submissions from your phone, with push notifications for urgent risks.",
  ...
  pl: {
    ...
    "lp.feat.f1d":  "Claude Sonnet czyta każde zgłoszenie w momencie jego otrzymania — PDF, Word lub treść e-maila, automatycznie wyciągając ponad 30 pól ryzyka. Wskaźniki dokładności opublikujemy po zakończeniu testów z partnerami projektowymi.",
    ...
    "lp.feat.f3d":  "Budujemy automatyczne generowanie Core Data Records przy każdym związaniu polisy, zgodne z ACORD 28 — zaprojektowane tak, by wymóg CDR nie oznaczał dodatkowej pracy inżynierskiej dla Twojego zespołu.",
    ...
    // Landing page — roadmap ("już dziś" vs "wkrótce" — szczerze o tym, co działa, a co planujemy)
    "lp.road.tag":  "Roadmapa",
    "lp.road.h2":   "Dokąd zmierzamy dalej",
    "lp.road.sub":  "Velox budujemy w otwarty sposób, razem z naszymi partnerami projektowymi. Oto co już działa, a co przygotowujemy na kolejne miesiące.",
    "lp.road.badge.now":  "Już w produkcie",
    "lp.road.badge.soon": "Wkrótce",
    "lp.road.r1t":  "Dwupoziomowe zatwierdzanie decyzji",
    "lp.road.r1d":  "Akceptacja seniora dla ryzyk wysokiego ryzyka, z pełnym zapisem kto, co i dlaczego zatwierdził — zaprojektowane pod kątem obrony decyzji przed regulatorem.",
    "lp.road.r2t":  "Integracje z systemami policy administration",
    "lp.road.r2d":  "Wysyłaj związane ryzyka bezpośrednio do systemów takich jak Sequel czy EZLynx — koniec z ręcznym przepisywaniem tych samych danych dwa razy.",
    "lp.road.r3t":  "Pomocnik reasekuracji i plasowania traktatów",
    "lp.road.r3d":  "Automatyczne generowanie arkuszy ekspozycji wg peryla i limitu oraz sugestie dopasowania traktatów na podstawie klasy i terytorium.",
    "lp.road.r4t":  "Śledzenie SLA i alerty",
    "lp.road.r4d":  "Konfigurowalne cele czasu do decyzji per broker, klasa i underwriter — z proaktywnymi alertami, zanim je przekroczysz.",
    "lp.road.r5t":  "Biblioteka reguł z kontrolą wersji",
    "lp.road.r5d":  "Gotowe zestawy reguł apetytu wg klasy, z możliwością cofania zmian i testów A/B — żeby nowi underwriterzy wdrażali się w dni, nie miesiące.",
    "lp.road.r6t":  "Natywna aplikacja mobilna",
    "lp.road.r6d":  "Przeglądaj i decyduj o skierowanych zgłoszeniach z telefonu, z powiadomieniami push o pilnych ryzykach.",
